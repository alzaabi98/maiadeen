        ...
        <div class="column is-one-third is-offset-one-third m-t-100">
            <div class="card">
                <div class="card-content has-text-right">
                    <h1 class="title"> انصم لعالم ميادين</h1>
                        <form action="{{ route('register') }}" method="POST" role="form">
                            ...
                            <div class="columns">
                                ...
                                <div class="column">
                                    ...
                                    <div class="field">
                                        <label for="password_confirm" class="label">تأكيد كلمة المرور </label>
                                        <p class="control">
                                            <input class=" input {{ $errors->has('password_confirm') ? 'is-danger' : '' }} " type="password" id="password_confirmation" name="password_confirmation">
                                        </p>
                            ...
                            <button class="button is-primary is-outlined is-fullwidth m-t-30">انضم الينا</button>
                        </form> {{-- end of form --}}
                </div>
            </div> {{-- end of card content --}}
            
            <h5 class="has-text-centered m-t-20"><a href="{{ route('login') }}"  class="is-muted"> سجلت مسبقا </a></h5>
        </div>
    </div>
