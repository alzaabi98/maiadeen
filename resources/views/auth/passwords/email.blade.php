                ...
                <div class="card-content has-text-right">
                    <h1 class="title"> نسيت كلمة المرور</h1>
                        <form action="{{ route('password.email') }}" method="POST" role="form">
                            ...
                            <button class="button is-primary is-outlined is-fullwidth m-t-30"> ارسال كلمة المرور</button>
                        </form> {{-- end of form --}}
                </div>
            </div> {{-- end of card content --}}
            <h5 class="has-text-centered m-t-20"><a href="{{ route('login') }}"  class="is-muted"> <i class="fa fa-caret-left"></i> الى صفحة الدخول</a></h5>
        </div>
    </div>
{{-- <div class="container">
    <div class="row">
